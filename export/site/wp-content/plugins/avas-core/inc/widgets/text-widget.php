<?php
/**
 * Widget API: tx_Widget_Text class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see WP_Widget
 */
class tx_Widget_Text extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'avas_text', __( 'Avas Text' ), $widget_ops, $control_ops );
	}
	...
	public function _register_one( $number = -1 ) {
		...
		add_action( 'admin_footer-widgets.php', array( 'tx_Widget_Text', 'render_control_template_scripts' ) );
	}
	...
	public function widget( $args, $instance ) {
		...
		/*
		 * Suspend legacy plugin-supplied do_shortcode() for 'tx_widget_text' filter for the visual Text widget to prevent
		 ...
		 */
		$widget_text_do_shortcode_priority       = has_filter( 'tx_widget_text', 'do_shortcode' );
		$should_suspend_legacy_shortcode_support = ( $is_visual_text_widget && false !== $widget_text_do_shortcode_priority );
		if ( $should_suspend_legacy_shortcode_support ) {
			remove_filter( 'tx_widget_text', 'do_shortcode', $widget_text_do_shortcode_priority );
		}
		 ...
		 * @since 4.8.1 The `$widget` param may now be a `WP_Widget_Custom_HTML` object in addition to a `tx_Widget_Text` object.
		 *
		 * @param string                               $text     The widget content.
		 * @param array                                $instance Array of settings for the current widget.
		 * @param tx_Widget_Text|WP_Widget_Custom_HTML $widget   Current text or HTML widget instance.
		 */
		$text = apply_filters( 'tx_widget_text', $text, $instance, $this );
		...
		if ( $is_visual_text_widget ) {
			 ...
			 * @param string         $text     The widget content.
			 * @param array          $instance Array of settings for the current widget.
			 * @param tx_Widget_Text $widget   Current Text widget instance.
			 */
			 ...
			 * Since the legacy Text widget runs wpautop() after 'tx_widget_text' filters are applied, the widget in
			 * legacy mode here manually applies do_shortcode() on the content unless the default
			 * core filter for 'widget_text_content' has been removed, or if do_shortcode() has already
			 * been applied via a plugin adding do_shortcode() to 'tx_widget_text' filters.
			 */
		...
		if ( $should_suspend_legacy_shortcode_support ) {
			add_filter( 'tx_widget_text', 'do_shortcode', $widget_text_do_shortcode_priority );
		}
	 ...
	 *
	 * @see tx_Widget_Text::render_control_template_scripts()
...
function tx_text_load_widget() {
	register_widget( 'tx_Widget_Text' );
}
add_action( 'widgets_init', 'tx_text_load_widget' );