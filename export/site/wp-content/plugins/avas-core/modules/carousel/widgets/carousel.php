<?php
namespace AvasElements\Modules\Carousel\Widgets;
...
class Carousel extends Widget_Base {
    ...
    public function get_name() {
        return 'avas-carousel';
    }

    public function get_title() {
        return esc_html__( 'Avas Carousel', 'avas-core' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .tx-car-grid-wrap',
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .tx-car-grid-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .tx-car-grid-wrap' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .tx-car-grid-wrap' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Background', 'avas-core' ),
                'types' => [ 'classic', 'gradient' ],
                'selector' => '{{WRAPPER}} .tx-car-grid-wrap:hover',
            ]
        );
        $this->add_group_control(
            Group_Control_Border::get_type(),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tx-car-grid-wrap:hover' => 'transition-duration: {{SIZE}}s',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tx-car-grid-wrap:hover .tx-car-grid-image img' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .tx-car-grid-wrap:hover .tx-car-grid-image img',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tx-car-grid-wrap:hover .tx-car-grid-image img' => 'transition-duration: {{SIZE}}s',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tx-car-grid-wrap:hover .tx-car-grid-icon-wrap i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .tx-car-grid-wrap:hover .tx-car-grid-icon-wrap svg' => 'fill: {{VALUE}};',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => false,
                'selectors'         => [
                    '{{WRAPPER}} .tx-car-grid-wrap'   => 'text-align: {{VALUE}};',
                ],
    ...
    public function render_header() {
        ...
        //Global Function
        $this->render_swiper_header_attribute('avas-carousel');
        $this->add_render_attribute('carousel', 'class', 'tx-widget-carousel');
    ?>
    ...
    <?php foreach ( $settings['items'] as $index => $item ) : 
        ...
        ?>
        <div <?php $this->print_render_attribute_string('tx-wrap'); ?>>
