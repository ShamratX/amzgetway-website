/**
 * AmzGetway — Townloc-style WhatsApp Live Support tab + Back to Top
 */
(function () {
  var PHONE = "8801985453254";
  var PREFILL = "Hi AmzGetway!";
  var HREF =
    "https://wa.me/" +
    PHONE +
    "?text=" +
  ...
  function isAdminPath() {
    ...
    return path.indexOf("/admin") === 0 || path.indexOf("/cms/") === 0;
  }

  function mountWa() {
    if (document.getElementById("amz-wa-float") || isAdminPath()) return;

    var a = document.createElement("a");
    a.id = "amz-wa-float";
    a.className = "amz-wa-tab";
    a.href = HREF;
    a.target = "_blank";
    ...
    a.innerHTML =
      ...
      WA_ICON +
      "</span>" +
      '<span class="amz-wa-label">LIVE SUPPORT</span>';
    document.body.appendChild(a);
  }

  function mountBackTop() {
    if (document.getElementById("amz-back-top") || isAdminPath()) return;
    ...
    btn.innerHTML =
      ...
      '<path fill="currentColor" d="M12 4l-7 7h4.5v9h5v-9H19z"/>' +
      "</svg>";
